...
import AdminSkillView from "@/components/admin-view/skill";
...
export default function AdminView() {
  ...
  const [skillViewFormData, setSkillViewFormData] = useState(
    initialSkillFormData
  );
  ...
  const menuItems = [
    ...
    },
    {
      ...
      component: (
        <AdminSkillView
          formData={skillViewFormData}
          handleSaveData={handleSaveData}
          setFormData={setSkillViewFormData}
          data={allData?.skill}
        />
      ),
    },
  ...
  function resetFormDatas() {
    ...
    setSkillViewFormData(initialSkillFormData);
  }
